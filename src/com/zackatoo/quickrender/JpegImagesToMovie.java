...
public class JpegImagesToMovie implements ControllerListener, DataSinkListener {
    ...
    public JpegImagesToMovie(int width, int height, int frameRate, String outputURL, Vector inputFiles)
            throws MalformedURLException, MovieCompileException
    {
        ...
        if ((oml = createMediaLocator(outputURL)) == null) {
            throw new MalformedURLException("Cannot create output URL from: " + outputURL);
        }

        if (!doIt(width, height, frameRate, inputFiles, oml))
        {
            throw new MovieCompileException("Unable to complete movie compilation - check system output");
        }
    }
